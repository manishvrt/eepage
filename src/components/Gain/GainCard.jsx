  ...
  return (
    <div className='lg:px-8 '>
      ...
      >
        ...
        <div className="lg:grid bg-[#ffffff] bg-opacity-30 border  dark:bg-[#101010] rounded-[35px] mt-4  dark:border-gray-900 flex  max-w-7xl mx-auto px-6 justify-between lg:grid-cols-5 items-center w-full py-6 relative z-10">
          ...
          <div className="lg:col-span-3">
            <div className="flex flex-col lg:flex-row lg:items-center justify-start items-start lg:space-x-10">
              ...
              <div className="flex lg:mt-0 mt-4 flex-col">
                ...
                <h1 className="lg:text-3xl tracking-wide text-2xl font-semibold gsans  text-[#0c0c0c] dark:text-[#ffffff]">
